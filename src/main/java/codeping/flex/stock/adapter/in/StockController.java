...
public class StockController {
    ...
    @Operation(summary = "주식 정보를 조회합니다.", description = "회사 이름, 코드, 이미지, 관심 종목 여부 등을 반환합니다.")
    ...
    @Operation(summary = "장전 시간 주식 시가/고가/저가/종가 조회", description = "장전 시간(오전 12~9시) 전일 주식 시가, 고가, 저가, 종가, 거래량,")
