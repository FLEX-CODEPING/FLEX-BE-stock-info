...
public class StockSearchController {
    ...
    public ApplicationResponse<List<StockAutoCompleteDto>> getAutoCompleteStocks(@Parameter(example = "삼성") @RequestParam("keyword") String keyword,
    ...
    public ApplicationResponse<List<StockAutoCompleteDto>> getStocksByKeyword(@Parameter(example = "stockName", description = "stockcode 또는 stockName 입력") @RequestParam("searchType") String searchType,
