...
public enum StockErrorCode implements BaseErrorCode {
    ...
    STOCK_OHLCV_NOT_FOUND(HttpStatus.NOT_FOUND, "STOCK_001", "해당 주식 OHLCV 정보를 찾을 수 없습니다."),
    STOCK_MARKET_CAP_NOT_FOUND(HttpStatus.NOT_FOUND, "STOCK_001", "해당 주식 시가총액 정보를 찾을 수 없습니다."),
    ;
